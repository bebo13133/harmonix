...
export const personsInControl = [
  { id: '1', name: 'Alice Brown' },
  { id: '2', name: 'Charlie Davis' },
  { id: '3', name: 'David Wilson' },
];

export const projectDirectors = [
  { id: '1', name: 'Eva Green' },
  { id: '2', name: 'Frank White' },
  { id: '3', name: 'Grace Lee' },
];

export const divisionalDirectors = [
  { id: '1', name: 'Henry Ford' },
  { id: '2', name: 'Irene Adams' },
  { id: '3', name: 'Jack Black' },
];