...
export const DatabaseProvider = ({ children }) => {
  ...
  const contextValue = {
    ...
    hsQuestions: createDataHandler('hsQuestions', loadDataFromDb, saveQuestionsDataToDb),
    environmentalQuestions: createDataHandler('environmentalQuestions', loadDataFromDb, saveQuestionsDataToDb),
    documentControlQuestions: createDataHandler('documentControlQuestions', loadDataFromDb, saveQuestionsDataToDb),
    saveFormData,
    loadFormData,
    updateFormData,
    deleteInspection,
